            ...
            <div class="row g-0">
              ...
              <div class="col-md-6 col-lg-12 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  <form method="POST">
                    @csrf 
                    <h2 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Đăng nhập</h2>
                    ...
                    <div class="pt-1 mb-4">
                      <button class="btn btn-dark btn-lg btn-block" style="background-color: #f0d394" type="button">Đăng nhập</button>
                    </div>
                    <a class="small text-muted" href="#!">Quên mật khẩu</a>
                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Bạn chưa có tài khoản? <a href="{{route('get.register')}}"
