...
<div class="slider-area an-1 hm-1">
   ...
   <div class="bend niceties preview-2">
       <div id="ensign-nivoslider" class="slides">	
           <img src="img/slider/home-1/macbook-coffee-desk-box.jpg" style="height:600px" alt="" title="#slider-direction-1"  />
           <img src="img/slider/home-1/airpod-iphone-nespresso-gadget.jpg"   style="height:600px" alt="" title="#slider-direction-2"  />
       </div>
       <!-- direction 1 -->
                                   ...
                                   <div class="single-product first-sale">
                                       <div class="product-img">
                                           <a href="{{route('get.detail.product',[$hot->pro_slug,$hot->id])}}">
                                               ...
                                               {{-- <img class="secondary-image" src="img/products/AppleWatchSeries8GPS45mmStarlightAluminumStarlightSport-600x600.png" alt="" /> --}}
                                           </a>
                                           <div class="action-zoom">
                                               <div class="add-to-cart">
                                                   <a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
                                           ...
                                           <div class="actions">
                                               <div class="action-buttons">
                                                   <div class="add-to-links">
                                                       ...
                                                       <div class="compare-button">
                                                           <a href="{{route('add.product',$hot->id)}}" title="Add to Cart"><i class="icon-bag"></i></a>
                                                       </div>									
                                                   </div>
                                                   <div class="quickviewbtn">
                                                       <a href="#" title="Add to Compare"><i class="fa fa-retweet"></i></a>
                                           ...
                                           <div class="price-box">
                                               <span class="new-price">{{number_format($hot->pro_price),0,'',''}} $</span>
                                           </div>
                                       </div>
                                       <div class="product-content">
                                           <h2 class="product-name"><a href="#">{{$hot->pro_name}}</a></h2>
                                           <p>{{$hot->pro_title_seo}}</p>
                                       </div>
                                   </div>
                               </div>
                           @endforeach
                       ...
                       <div class="col-md-4 col-sm-4 col-xs-12">
                           <div class="single-post">
                               <div class="post-thumb">
                                   <a href="#">
                                       <img src="{{pare_url_file($article->a_avatar)}}" style="width:370px; height:280px;" alt="" />
                                   </a>
                               </div>
