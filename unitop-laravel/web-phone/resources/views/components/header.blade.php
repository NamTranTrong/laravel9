                ...
                <div class="top-detail">
                        ...
                        <div class="circle-shopping expand">
                            <div class="shopping-carts text-right">
                                <div class="cart-toggler">
                                    <a href="{{route('get.list.shoppingCart')}}"><i class="icon-bag"></i></a>
                                    <a href="{{route('get.list.shoppingCart')}}"><span class="cart-quantity">{{\Cart::getContent()->count()}}</span></a>
                                </div>
                                <div class="restrain small-cart-content" style="text-align:left;top:63%; !important">
                                    <ul class="cart-list"">
                                        <li>
                    ...
                    <div class="disflow">
                        <div class="expand dropps-menu">
                            ...
                            <ul class="restrain language" style="width:200px;text-align:left;margin-top:-21px" >
                                @if(Auth::check())
