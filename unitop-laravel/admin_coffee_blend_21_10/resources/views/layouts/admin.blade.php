...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('elaadmin-master/assets/css/cs-skin-elastic.css') }}">
    <link rel="stylesheet" href="{{ asset('elaadmin-master/assets/css/style.css') }}">
...
<body>
    ...
    <script src="{{asset('admin-js-css/sidebar/get_active.js')}}"></script> 
    @yield('js')
</body>
