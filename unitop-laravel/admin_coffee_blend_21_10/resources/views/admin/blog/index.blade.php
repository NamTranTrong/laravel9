...
@section('css')
    <link rel="stylesheet" href="{{asset('admin-js-css/blog/index/index.css')}}">
@endsection

@section('content')
    @include('partials.breadcrumbs', ['name' => 'Blog', 'key' => 'List'])
    <div class="content">
                                                    ...
                                                    <tr role="row">
                                                        <td class="col-1">
                                                            <input type="checkbox" value="{{$blog->id}}"
                                                                class="form-control-input blog-checkbox">
                                                        </td>
                                                        <td class="col-2">{{$blog->name}}</td>
                                                        <td class="col-3">
                                                        ...
                                                        <td class="col-3 contain-imgs">
                                                            <div class="main-image">
                                                                <img src="{{$blog->feature_image_path}}" alt="Main Image">
                                                            </div>
                                                        </td>
                                                        <td class="col-auto">
                                                            <div class="d-flex justify-content-center">
                                                                <span class="mx-2">
                                                                    <a  data-url="{{route('blog.delete',['id' => $blog->id])}}" class="action_delete">
...
@section('js')
    <script src="{{asset('admin-js-css/blog/index/index.js')}}"></script>
