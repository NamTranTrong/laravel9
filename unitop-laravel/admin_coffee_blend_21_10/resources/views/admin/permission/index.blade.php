...
@section('content')
    @include('partials.breadcrumbs', ['name' => 'Permission', 'key' => 'List'])
    <div class="content">
                                        ...
                                        <table id="bootstrap-data-table"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc" tabindex="0"
                                                        ...
                                                        style="width: 238.2px;">Module</th>
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                                        style="width: 380.2px;">Permission</th>
                                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                            ...
                                            <tbody>
                                                @foreach ($permissionParents as $permissionParent)
                                                    <tr role="row">
                                                        <td class="col-1">
                                                            <input type="checkbox" value="{{ $permissionParent->id }}"
                                                                class="form-control-input category-checkbox">
                                                        </td>
                                                        <td class="col-8">{{ $permissionParent->name }}</td>
                                                        
                                                        <td class="col-2">
                                                            <ul class="ml-4">
                                                                @foreach ($permissions as $permission)
                                                                    @if ($permission->parent_id == $permissionParent->id)
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex justify-content-center">
                                                                <span class="mx-2">
                                                                    <a href="{{ route('permission.delete', ['id' => $permissionParent->id]) }}"
                                                                        class="action_delete">
                                                                ...
                                                                <span class="mx-2">
                                                                    <a
                                                                        href="{{ route('permission.edit', ['id' => $permissionParent->id]) }}">
