...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('admin-css-js/menu/edit/edit.css')}}">
@endsection
                    ...
                    <div class="col-md-6">
                        <form action="{{route('menu.update',['id' => $menu->id])}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control js-example-placeholder-single " name="parent_id">
...
@section('js')
    ...
    <script src="{{asset('admin-css-js/menu/edit/edit.js')}}"></script>
@endsection